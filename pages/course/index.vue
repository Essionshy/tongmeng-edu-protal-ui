      ...
      <section class="c-sort-box">
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                ...
                <li v-for="firstSubject in firstSubjectList" :key="firstSubject.id">
                  <a :title="firstSubject.tiltle" href="javascript:void(0);" @click="searchOne(firstSubject.id, index)">{{firstSubject.title}}</a>
                </li>
              </ul>
            </dd>
          </dl>
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li v-for="secondSubject in secondSubjectList" :key="secondSubject.id">
    ...
    methods: {
      ...
      initSubject() {
        courseApi.getSubjectList().then(response => {
          this.firstSubjectList = response.data.data.rows
        })
      },
      ...
      searchOne(subjectParentId, index) {
        ...
        for (let i = 0; i < this.firstSubjectList.length; i++) {
          if (this.firstSubjectList[i].id === subjectParentId) {
